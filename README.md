...
Unofficial Implementation from [A neural-AdaBoost based facial expression recognition system](doi.org/10.1016/j.eswa.2013.11.041) </br>
  ### Ada.py
  An Improved Adaboost Algorithm to select best N features from Gabor Filters Bank that distinguish between Face (affectNet) / No Face (CIFAR-10) after balancing both datasets.  
